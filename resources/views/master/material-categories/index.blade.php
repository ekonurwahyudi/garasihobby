...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
    <li class="breadcrumb-item text-muted">Kategori Material</li>
@endsection
...
$(document).ready(function() {
    table = $('#kt_table').DataTable({
        ...
        buttons: [
            {
                extend: 'excelHtml5',
                title: 'Kategori Material - Garasi Hobby',
...
function openEditModal(id) {
    ...
    fetch('/master/material-categories/' + id + '/edit', {
...
function deleteItem(id, name) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('/master/material-categories/' + id, {
                method: 'DELETE',
                headers: {
...
document.getElementById('dataForm').addEventListener('submit', function(e) {
    ...
    var url = formMode === 'create' ? '{{ route("material-categories.store") }}' : '/master/material-categories/' + editId;
