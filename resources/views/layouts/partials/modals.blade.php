									...
									<div class="current" data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="fv-row mb-10">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-lg form-control" name="name" placeholder="" value="" />
												<!--end::Input-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="fv-row mb-10">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-lg form-control" name="dbname" placeholder="" value="master_db" />
												<!--end::Input-->
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100">
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<!--end::Label-->
												<input type="text" class="form-control form-control" placeholder="" name="card_name" value="Max Doe" />
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													<!--begin::Input-->
													<input type="text" class="form-control form-control" placeholder="Enter card number" name="card_number" value="4111 1111 1111 1111" />
													<!--end::Input-->
													<!--begin::Card logos-->
											...
											<div class="row mb-10">
												...
												<div class="col-md-8 fv-row">
													...
													<div class="row fv-row">
														<!--begin::Col-->
														<div class="col-6">
															<select name="card_expiry_month" class="form-select form-select" data-control="select2" data-hide-search="true" data-placeholder="Month">
																<option></option>
														...
														<!--begin::Col-->
														<div class="col-6">
															<select name="card_expiry_year" class="form-select form-select" data-control="select2" data-hide-search="true" data-placeholder="Year">
																<option></option>
												...
												<div class="col-md-4 fv-row">
													...
													<div class="position-relative">
														<!--begin::Input-->
														<input type="text" class="form-control form-control" minlength="3" maxlength="4" placeholder="CVV" name="card_cvv" />
														<!--end::Input-->
														<!--begin::CVV icon-->
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="mb-10 fv-row">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<input type="text" class="form-control form-control-lg form-control" name="campaign_name" placeholder="" value="" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
										<!--begin::Input group-->
											...
											<div class="mh-300px scroll-y me-n7 pe-7">
												...
												<div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
													...
													<div class="min-w-100px">
														<select class="form-select form-select form-select-sm" data-control="select2" data-hide-search="true" data-placeholder="Edit">
															<option></option>
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<!--end::Duration option-->
											<!--begin::Datepicker-->
											<input class="form-control form-control d-none" placeholder="Pick date & time" id="kt_modal_create_campaign_datepicker" />
											<!--end::Datepicker-->
										</div>
										<!--end::Input group-->
										<!--begin::Input group-->
