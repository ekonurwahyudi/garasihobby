...
class AssetPurchaseController extends Controller
{
    ...
    public function approve(AssetPurchase $asset_purchase): RedirectResponse
    {
        ...
        DB::transaction(function () use ($asset_purchase) {
            ...
            if ((float) $bank->balance < (float) $asset_purchase->purchase_amount) {
                throw ValidationException::withMessages(['bank_account_id' => 'Saldo bank tidak mencukupi untuk pembelian aset ini.']);
            }
